    ...
    <div class="relative w-full justify-center h-fit min-h-screen hidden md:flex flex-col gap-10">
        <div class="w-full flex justify-center h-auto z-10">
            ...
            <div class="relative w-full md:w-1/2 flex justify-center items-center overflow-hidden">
                ...
                @endif
                <form wire:submit.prevent="sendOtp" class="w-full h-fit max-w-sm flex flex-col justify-center items-center px-10 py-10 bg-white z-10 rounded-xl mt-10">
                    <div class="flex flex-col justify-center items-center mb-8">
                        <h1 class="font-semibold text-lg">Verify Your Account</h1>
    ...
    <div class="relative w-full h-auto flex flex-col gap-4 px-3 py-6 md:hidden">
        ...
        <div class="relative w-full z-10">
            ...
            @elseif (session('success'))
                <div class="text-green-600">{{ session('success') }}</div>
            @endif
            <form wire:submit.prevent="sendOtp" class="mx-auto border border-[#316943] w-full h-fit max-w-sm flex flex-col justify-center items-center px-5 py-5 bg-white/50 z-10 rounded-xl">
                <div class="flex flex-col justify-center items-center mb-8">
                    <h1 class="font-semibold text-lg">Verify Your Account</h1>
                    <p class="text-sm">Access your MelonTrack dashboard</p>
                </div>
