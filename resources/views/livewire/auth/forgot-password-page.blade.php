<div class="relative flex justify-center h-auto">
    ...
    <div class="relative w-full justify-center h-fit min-h-screen hidden md:flex flex-col gap-10">
        <div class="w-full flex justify-center h-auto z-10">
            ...
            <div class="relative w-full md:w-1/2 flex justify-center items-center overflow-hidden">
                <form wire:submit.prevent="forgot" class="w-full h-fit max-w-sm flex flex-col justify-center items-center px-10 py-10 bg-white z-10 rounded-xl mt-10">
                    <div class="flex flex-col justify-center items-center mb-4">
                        <div class="w-12 h-12 bg-[#f2f5e2] rounded-full flex justify-center items-center px-2 py-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
                            </svg>
                        </div>

                        <h1 class="font-semibold text-lg">Forgot Password?</h1>
                        <p class="text-xs text-center">No problem! Enter your registerd email address and we'll send you a link to reset your password.</p>
                    </div>

                    <div class="w-full flex flex-col justify-center items-center">
                        <div class="space-y-4 w-[90%] md:w-full">
                            <div class="relative">
                                <x-input icon="mail" label="Registered Email Address" placeholder="Enter your registered email" wire:model="email" class="py-3"/>
                            </div>
                        </div>
                    </div>
                    <button
                        ...
                        wire:target="forgot"
                        class="w-[90%] md:w-full py-2 px-4 mt-5 inline-flex justify-center items-center gap-x-2 text-base font-medium border border-transparent bg-[#346844] text-white hover:bg-[#346844] disabled:opacity-50 disabled:pointer-events-none rounded-xl"
                    >
                        <span wire:loading.remove wire:target="forgot">Send Reset Link</span>
                        <span wire:loading wire:target="forgot">Sending...</span>
                    </button>
                    ...
                    <div class="flex text-sm gap-1">
                        <span>Still having trouble?</span> <a href="#" class="text-[#95d78e]">Contact Support</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="relative w-full h-auto flex flex-col gap-4 px-3 py-6 md:hidden">
        ...
        <div class="relative w-full z-10">
            <form wire:submit.prevent="forgot" class="mx-auto border border-[#316943] w-full h-fit max-w-sm flex flex-col justify-center items-center px-5 py-5 bg-white/50 z-10 rounded-xl">
                <div class="flex flex-col justify-center items-center mb-4">
                    <div class="w-12 h-12 bg-[#f2f5e2] rounded-full flex justify-center items-center px-2 py-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
